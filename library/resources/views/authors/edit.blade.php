                    ...
                    <form action="{{ route('authors.update', ['author' => $author->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="name" name="name" type="text"
                                value="{{ $author->name }}" placeholder="Inserisci il nome dell autore">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="surname" name="surname" type="text"
                                value="{{ $author->surname }}" placeholder="Inserisci il cognome dell'autore">
                            @error('surname')
                                <span class="text-danger">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="birth" name="birth" type="date"
                                value="{{ $author->birth->format('yy-d-m') }}"
